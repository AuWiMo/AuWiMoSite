  ...
  return (
    <div className='matrix_font intro_text' style={{display: 'flex', flexDirection: "row", margin: '3vh', width: '100%', justifyContent: 'flex-start', overflow: 'hidden', position: 'relative'}}> 
      <div style={{whiteSpace: 'nowrap', background}} className='gradient_text' >
        011000010111010101110111011010010110110101101111 011000010111010101110111011010010110110101101111 
        011000010111010101110111011010010110110101101111 011000010111010101110111011010010110110101101111 011000010111010101110111011010010110110101101111
      </div>
    </div>
  );
};
